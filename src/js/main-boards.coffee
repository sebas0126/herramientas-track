...
@funcionGrphits = (j) ->
  Highcharts.chart 'containerBar' + j,
    chart: type: 'column'
    title: text: ' Distribuidor' + j
    subtitle: text: ''
    xAxis: type: 'category'
    yAxis: title: text: ''
...
@functionCont = (t) ->
  ...
  while i < t
    ...
    funcionGrphits(i)
    # includeHtml = includeHtml.concat("<div id='containerBar" + i + "' class='col-md-6' style='min-width: 310px; height: 400px; max-width: 600px; margin: 0 auto'></div>")
